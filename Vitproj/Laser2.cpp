...
void Laser2::InitLaser(Bullet* b_bullet, SDL_Renderer* renderer)
{
	...
	b_bullet->SetRect(860, 400);
	bullet_list.push_back(b_bullet);

}

void Laser2::MakeBullet(SDL_Renderer* renderer)
{
